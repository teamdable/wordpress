...
* [South Korea](http://dable.io/ko/contact_media/)
* [Other countries](http://dable.io/en/contact_en/)
...
Download plugins from Wordpress plugins pages.
...
= 1.3.3 =
* change author URI, add icons

= 1.3.4 =
* do not add `dable:item_id` meta tag for unpublished or password protected articles.

= 2.0.0 =
* Add support for WordPress Widgets
...
= 3.3.3 =
* Content widget now respects Target Post Types setting